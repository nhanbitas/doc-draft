(function () {
  ...
  showdown.Converter = function (converterOptions) {
    ...
    this.makeHtml = function (text) {
      ...
      text = text.replace(/\xa8D/g, "$$");
      text = text.replace(/\xa8T/g, "\xa8");
  ...
  showdown.subParser("blockQuotes", function (text, options, globals) {
    ...
    text = text.replace(rgx, function (bq) {
      ...
      bq = bq.replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function (wholeMatch, m1) {
        var pre = m1;
        pre = pre.replace(/^  /gm, "\xa80");
        pre = pre.replace(/\xa80/g, "");
        return pre;
      });
  ...
  showdown.subParser("detab", function (text, options, globals) {
    ...
    text = text.replace(/\xa8B(.+?)\xa8A/g, function (wholeMatch, m1) {
      var leadingText = m1,
    ...
    text = text.replace(/\xa8A/g, "    ");
    text = text.replace(/\xa8B/g, "");
  ...
  showdown.subParser("lists", function (text, options, globals) {
    ...
    function processListItems(listStr, trimTrailing) {
      ...
      listStr = listStr.replace(/\xa80/g, "");
      globals.gListLevel--;
      if (trimTrailing) {
  ...
  showdown.subParser("paragraphs", function (text, options, globals) {
    ...
    for (i = 0; i < end; i++) {
      var blockText = "",
        ...
        codeFlag = false;
      while (/\xa8(K|G)(\d+)\1/.test(grafsOutIt)) {
        var delim = RegExp.$1,
          num = RegExp.$2;
        if (delim === "K") {
  ...
  showdown.subParser("unescapeSpecialChars", function (text, options, globals) {
    ...
    text = text.replace(/\xa8E(\d+)E/g, function (wholeMatch, m1) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  //   Test metadata
  document.metadata = converter.getMetadata();
  document.metadata.tabs = JSON.parse(document.metadata.tabs.replace(/'/g, '"'));
